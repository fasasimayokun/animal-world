...
import { createAnimalPost, deleteAniamlPost, getAllAnimalPost,
    getSingleAnimalPost, thumbsUpAndDownOnAnimal, updateAnimalPost } from "../controllers/animal.controller.js";
...
router.post('/vote/:animalId/:voteType', protectRoute, thumbsUpAndDownOnAnimal);
